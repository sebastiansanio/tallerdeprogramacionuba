...
list<string>* R::realizarOpearacion(list<char*>* operandos){
	...
	query="insert into usuarios (usuario,password,plata,fechaRegistro,fechaUltimaCarga,cargaUltimoDia) values ('"+usuario+"','"+pass+"',2000, CURRENT_DATE,CURRENT_DATE,2000)";
	res = conexion->ejecutarQuery(query.c_str());
	conexion->liberarConexion(res);
